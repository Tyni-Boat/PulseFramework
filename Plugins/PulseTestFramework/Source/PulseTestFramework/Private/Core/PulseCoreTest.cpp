...
bool FCoreSerializationTest::RunTest(const FString& Parameters)
{
	...
	FSerializationTester1 v1 = FSerializationTester1();
	v1.TestValue = -12.36;
	const auto v1Json = UPulseSystemLibrary::UStructToJsonString(v1);
	FSerializationTester1 v2 = FSerializationTester1();
	const auto jsonDesV2 = UPulseSystemLibrary::JsonStringToUStruct(v1Json, v2);
	result += TestEqual(TEXT("Compare JSON"), v2.TestValue, v1.TestValue);
	return result >= 4;
}
