...
#include "PulseTweenBPActionRotator.generated.h"

DECLARE_DYNAMIC_MULTICAST_DELEGATE_OneParam(FTweenUpdateRotatorOutputPin, FRotator, Value);

UCLASS()
class PULSEGAMEFRAMEWORK_API UPulseTweenBPActionRotator : public UPulseTweenBPActionBase
{
	GENERATED_BODY()
public:
	FQuat Start;
	...
	static UPulseTweenBPActionRotator* TweenRotator(FRotator Start = FRotator::ZeroRotator, FRotator End = FRotator::ZeroRotator,
	...
	static UPulseTweenBPActionRotator* TweenRotatorCustomCurve(FRotator Start = FRotator::ZeroRotator,
