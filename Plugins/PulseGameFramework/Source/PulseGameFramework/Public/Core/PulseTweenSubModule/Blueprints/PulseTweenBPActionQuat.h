...
#pragma once
#include "PulseTweenBPActionBase.h"
#include "Core/PulseTweenSubModule/PulseTweenInstance.h"
#include "Kismet/BlueprintAsyncActionBase.h"

#include "PulseTweenBPActionQuat.generated.h"

DECLARE_DYNAMIC_MULTICAST_DELEGATE_OneParam(FTweenUpdateQuatOutputPin, FQuat, Value);

UCLASS()
class PULSEGAMEFRAMEWORK_API UPulseTweenBPActionQuat : public UPulseTweenBPActionBase
{
	GENERATED_BODY()
public:
	FQuat Start;
	...
	static UPulseTweenBPActionQuat* TweenQuat(FQuat Start, FQuat End, float DurationSecs = 1.0f, EPulseEase EaseType = EPulseEase::InOutQuad,
	 ...
	 */
	UFUNCTION(BlueprintCallable, meta = (BlueprintInternalUseOnly = "true", AdvancedDisplay = "4"), Category = "Tween")
	static UPulseTweenBPActionQuat* TweenQuatFromRotator(FRotator Start = FRotator::ZeroRotator, FRotator End = FRotator::ZeroRotator,
		float DurationSecs = 1.0f, EPulseEase EaseType = EPulseEase::InOutQuad, float EaseParam1 = 0, float EaseParam2 = 0,
	...
	static UPulseTweenBPActionQuat* TweenQuatCustomCurve(FQuat Start, FQuat End, float DurationSecs = 1.0f,
	 ...
	 */
	UFUNCTION(BlueprintCallable, meta = (BlueprintInternalUseOnly = "true", AdvancedDisplay = "4"), Category = "Tween|Custom Curve")
	static UPulseTweenBPActionQuat* TweenQuatFromRotatorCustomCurve(FRotator Start = FRotator::ZeroRotator,
	...
	virtual PulseTweenInstance* CreateTween() override;
	virtual PulseTweenInstance* CreateTweenCustomCurve() override;
};
