...
#include "PulseTweenBPActionVector2D.generated.h"

DECLARE_DYNAMIC_MULTICAST_DELEGATE_OneParam(FTweenUpdateVector2DOutputPin, FVector2D, Value);

UCLASS()
class PULSEGAMEFRAMEWORK_API UPulseTweenBPActionVector2D : public UPulseTweenBPActionBase
{
	GENERATED_BODY()
public:
	FVector2D Start;
	...
	static UPulseTweenBPActionVector2D* TweenVector2D(FVector2D Start = FVector2D::ZeroVector, FVector2D End = FVector2D::ZeroVector,
	...
	static UPulseTweenBPActionVector2D* TweenVector2DCustomCurve(FVector2D Start = FVector2D::ZeroVector,
