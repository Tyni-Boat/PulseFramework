...
#include "PulseTweenBPActionVector.generated.h"

DECLARE_DYNAMIC_MULTICAST_DELEGATE_OneParam(FTweenUpdateVectorOutputPin, FVector, Value);

UCLASS()
class PULSEGAMEFRAMEWORK_API UPulseTweenBPActionVector : public UPulseTweenBPActionBase
{
	GENERATED_BODY()
public:
	FVector Start;
	...
	static UPulseTweenBPActionVector* TweenVector(FVector Start = FVector::ZeroVector, FVector End = FVector::ZeroVector,
	...
	static UPulseTweenBPActionVector* TweenVectorCustomCurve(FVector Start = FVector::ZeroVector, FVector End = FVector::ZeroVector,
