...
#include "AssetManager/AsyncLoadBatchGameAsset.h"
#include "AssetManager/PulseAssetManager.h"
#include "AssetManager/Types/BasePulseAsset.h"



UAsyncLoadBatchGameAsset* UAsyncLoadBatchGameAsset::LoadPulseAssetBatch(UObject* WorldContextObject, const TSubclassOf<UBasePulseAsset> Type, const TSet<int32>& AssetIds,
                                                                       int32 flag)
{
