...
#include "Core/PulseTweenSubModule/Blueprints/PulseTweenBPActionVector.h"
#include "Core/PulseTweenSubModule/PulseTweenSystemCore.h"


UPulseTweenBPActionVector* UPulseTweenBPActionVector::TweenVector(FVector Start, FVector End, float DurationSecs, EPulseEase EaseType,
...
{
	UPulseTweenBPActionVector* BlueprintNode = NewObject<UPulseTweenBPActionVector>();
...
UPulseTweenBPActionVector* UPulseTweenBPActionVector::TweenVectorCustomCurve(FVector Start, FVector End, float DurationSecs,
...
PulseTweenInstance* UPulseTweenBPActionVector::CreateTween()
{
	return PulseTweenSystemCore::Play(
		Start, End, [&](FVector t) { ApplyEasing.Broadcast(t); }, DurationSecs, EaseType);
}

PulseTweenInstance* UPulseTweenBPActionVector::CreateTweenCustomCurve()
{
	return PulseTweenSystemCore::Play(
		0, 1,
		[&](float t)
