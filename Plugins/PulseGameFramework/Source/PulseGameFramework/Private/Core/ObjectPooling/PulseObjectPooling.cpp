...
#include "Core/ObjectPooling/PulseObjectPooling.h"
...
bool IIPoolingObject::OnPoolQuery_Implementation(const FPoolingParams SpawnData)
{
	return true;
}

void IIPoolingObject::OnPoolDispose_Implementation()
{
}

EPoolQueryResult IIPoolingObject::Dispose()
{
...
EPoolQueryResult IIPoolingObject::DisposeToPool_Implementation()
{
	return Dispose();
}
...
EPoolQueryResult UPulseObjectPooling::QueryObject(UObject* Owner, TSubclassOf<UObject> Class, UObject*& Output, FPoolingParams QueryParams)
{
	...
	if (QueryParams.IsValid())
	{
		...
		{
			if (!IIPoolingObject::Execute_OnPoolQuery(Object, QueryParams))
			{
...
EPoolQueryResult UPulseObjectPooling::DisposeObject(UObject* Object)
{
	...
	if (Object->Implements<UIPoolingObject>())
	{
		IIPoolingObject::Execute_OnPoolDispose(Object);
	}
	if (auto asActor = Cast<AActor>(Object))
	{
